...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [0] = LAYOUT(
    ...
    KC_F16,  KC_F17,   KC_CAPSLOCK,KC_A,  KC_S,    KC_D,   KC_F,   KC_G,                 KC_H,   KC_J,   KC_K,    KC_L,   KC_SCLN, KC_QUOT,  KC_ENTER,                    KC_PGDN,
    KC_F18,  KC_F19,   KC_LSFT,  KC_Z,    KC_X,    KC_C,   KC_V,   KC_B,                 KC_N,   KC_M,   KC_COMM, KC_DOT, KC_SLSH,                     KC_RSFT,  KC_UP,   KC_END,
    KC_F20,  KC_F21,   KC_LCTRL, KC_LALT, KC_LGUI, KC_SPC, KC_SPC /* This is FN */,              KC_SPC, KC_RGUI, KC_RALT,KC_RCTL,                     KC_LEFT,  KC_DOWN, KC_RIGHT
  ),
  [1] = LAYOUT(
